...
<body>
	...
	<div class="top">
		<div class="topbar">
			<span class="welcome" style="float: left">欢迎光临商城系统 ,请<a
				href="login.jsp" class="red"> 登录</a>&nbsp;<a href="rege.jsp"
				style="padding-left: 0; padding-right: 10px"> 免费注册 </a>
			</span> 
			<span class="operate_nav"> <span id="account"
				style="background-color: rgb(245, 245, 245);">
				<a rel="nofollow">我的账号&nbsp;</a><i id="icount"
					class="fa fa-angle-down"></i> </span>
				<ul id="dbox" class="top_lg_info_down" style="display: none;">
					<li><a rel="nofollow" href="userMain.page">个人中心</a></li>
				</ul> |
			</span> <span class="operate_nav"> <a rel="nofollow" href="">我的订单</a>
				|
			</span> <span class="operate_nav"> <a href="index.cart" name="购物车"
				dd_name="购物车"><i class="icon_card"></i>购物车<b
					id="cart_items_count"></b></a>
			</span>
		</div>
	</div>
	<script type="text/javascript">
	...
	<div class="wrapper-cart">
		...
		<div class="header-wrap">
			<a href="" class="logo" title="商城系统"><img src="images/logo.png" alt="商城系统" /></a>
			<div class=""></div>
		</div>
		<!-- /头部 -->
		<!-- 主体 -->
		<div class="wrapper-order">
			<div class="mainwrap">
				<div class="think-form">
					<div class="loginform">
						<div class="hd">
							<strong>用户登录</strong> <span>没有帐号？点击<a href="rege.jsp">注册</a></span>
						</div>
					...
					<div class="login-other">
						<form name="frm" class="form-horizontal login-user"
							...
							<div class="control-group">
								...
								<div class="controls">
									<img id="CreateCheckCode" src="genImage.yzm"> <a
										href="javascript:;" onclick="changeImage()"> 看不清</a> <input
										id="yzm" class="v_inp" placeholder="请输入验证码" name="yzm"
										type="text"> <label id="tyzm"></label>
								</div>
								<div class="controls Validform_checktip text-warning"></div>
							</div>
