    ...
    <div class="nav-all"> 
     ...
     <div class="all-goods" style="display: none;" id="all-goods"> 
      ...
      <c:forEach items="${bigTypes }" var="bigType">
         <div class="item"> 
          <div class="product">
           <h4><a href="searchServlet?bid=${bigType.id }&p=1">${bigType.name }</a> </h4>
          </div> 
           ...
           <div class="cf"> 
            <div class="fl wd252 pr20"> 
             ...
             <c:forEach items="${bigType.smallTypeList }" var="smallType">
              <li><span><a href="searchServlet?sid=${smallType.id }&p=1">${smallType.name }</a></span> </li> 
              </c:forEach>
             </ul>
   ...
   <div class="commom_wrapper"> 
    ...
    <div class="main"> 
     <div class="main_nav">
      ...
      <a href="searchServlet?bid=${goodsBean.bigTypeId}&p=1">${goodsBean.bigTypeName}</a>&gt;
      <a href="searchServlet?sid=${goodsBean.smallTypeId}&p=1">${goodsBean.smallTypeName}</a>&gt;
         ...
         <div class="addcart_box">
          ...
          <div id="showIncludeCart" style="display:none;"> 
           ...
           <div class="buy_pop_top">
            ...
            <div class="font"> 购物车共  <font id="totalnum" class="red"></font> 件宝贝
...
function buy(i) {
	...
	success:function(data) {
		var html='<li><dl><dt class="mini-img">'+href+image+'</a><dd><span class="mini_title">'+href+title+'</a></span><span class="mini-cart-count red"> ￥'
			+gprice+'<em class="'+string+'">*'+gnum+'</em></span>'+'</dd><dd><span class="mini-cart-info">'+parameters+'</span><span class="mini-cart-del"><a name="'
			+string+'" rel="del"  onclick="delcommon(event);return false;">删除</a></span></dd>'+'</dl></li>';//创建节点〉
		if(data.exsit=="1"){
