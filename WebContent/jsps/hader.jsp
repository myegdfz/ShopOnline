...
<div class="header">
	<a href="/zo_omyshop" class="logo" title="商城系统"><img src="images/logo.png"
		alt="商城系统" /></a>
			...
			<form action="searchServlet" name="Searchform" method="post">
				<p>
					<input type="text" name="name" placeholder="输入您想要的商品"
						class="search" /><a rel="nofollow" href="javascript:void(0)"
						class="search_btn"></a>
				</p>
	...
	<div class="top_right">
		...
		<div id="goods" class="sc_goods" style="display:none;">
			...
			<div class="sc_goods_foot" <c:if test="${gwcGoodsList.size()==0 }"></c:if> >
