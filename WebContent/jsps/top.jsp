	...
	<div class="top">
		<div class="topbar">
			<span class="welcome" style="float:left"><a
				...
				onclick="SetHome(this,'http://localhost:8080/zo_omyshop')">设为首页</a> <a
				href="javascript:void(0);"
				onclick="AddFavorite('myshop商城',location.href)" title="myshop商城">收藏本站</a>
			</span> <span class="welcome" style="float:left"> <a
				href="javascript:void(0);"
				onclick="AddFavorite('myshop商城',location.href)" title="myshop商城"></a>
			</span>
			<div class="topaccount">
				...
				<c:if test="${username!=null }">
					<span class="operate_nav"> 欢迎光临商城 <a href="" class="red">${username}</a>,<a
						rel="nofollow" href="logout.user">退出</a> |
					</span>
				</c:if>
				<c:if test="${username==null }">
					<span class="operate_nav"> 欢迎光临商城 ,请<a href="login.jsp">[登录]</a>&nbsp;<a
