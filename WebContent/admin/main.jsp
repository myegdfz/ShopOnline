...
<table style="padding: 5px;" width="100%">
	<tr>
		...
		<td valign="bottom" align="right" width="100%"><font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${adminName }</font></td>
	</tr>
</table>
</div>
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px;"><font style="font-family: Courier new;" color="red" size="10">后台</font></div>
		</div>
	</div>
</div>
