...
public class goodsServlet extends HttpServlet {
	...
	public void sel(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String p = request.getParameter("page");	//页码
		String rows = request.getParameter("rows");	//行
		String sel = request.getParameter("name");	//查询不为空
	...
	public void addShoppingCart(HttpServletRequest request, HttpServletResponse response)
		...
		if(username==null){
			//没有登录
			System.out.println("用户未登录  购物车放入session中");
